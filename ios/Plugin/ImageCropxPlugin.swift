 ...
 */
@objc(ImageCropxPlugin)
public class ImageCropxPlugin: CAPPlugin, CropViewControllerDelegate {
    var id: String?
    @objc func show(_ call: CAPPluginCall) {
        ...
        DispatchQueue.main.async {
            ...
            if (width > 0 && height > 0) {
                ...
                let gcd = ImageCropxPlugin.gcd(width: width, height: height)
    ...
    public func cropViewController(_ cropViewController: CropViewController, didCropToImage image: UIImage, withRect cropRect: CGRect, angle: Int) {
        ...
        do {
            if (call != nil) {
                ...
                object["value"] = self.bridge?.portablePath(fromLocalURL: path)?.absoluteString
